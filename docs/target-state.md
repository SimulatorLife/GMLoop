...
* Hover must describe project symbols and documented runtime built-ins while treating reserved language keywords as non-hoverable syntax. Documented callable project symbols, including constructor static methods, must expose their description, parameter names and types, and return information.
