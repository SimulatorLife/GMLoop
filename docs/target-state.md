...
Concrete graph-index design and implementation details now live in [docs/gml-graph-index-plan.md](GMLoop/docs/gml-graph-index-plan.md). Graph/search/context retrieval is owned by `@gmloop/semantic`.
