...
- Do **NOT** modify agent-specific files such as `AGENTS.md`, `GEMINI.md`, `.github/copilot-instructions.md`, `.gemini/**`, `.qwen/**`, `.aiderignore`, `.codex/**` unless the user explicitly asks you to do so.
