 ...
 * - statement-print.ts        – per-statement spacing, semicolon, and original-source
 *                               probing helpers (printStatements,
 *                               printGlobalVarStatementAsKeyword, getSourceTextForNode,
 *                               structLiteralHasLeadingLineBreak, buildIfStatementDoc,
 *                               plus the `if` / `else if` / `else` ladder builders).
 *
...
import {
    ...
    printGlobalVarStatementAsKeyword,
    printStatements,
    structLiteralHasLeadingLineBreak
} from "./statement-print.js";
