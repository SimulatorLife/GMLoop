import type { GmlFormatComponentBundle, GmlFormatDefaultOptions, GmlSourceFormatter } from "./format-types.js";
 ...
 * printer, comment, Prettier runtime, or layout-normalization implementations
 * directly. Concrete adapters are assembled behind this boundary by the format
 * component module.
 */
export type GmlFormatProvider = Readonly<{
    components: GmlFormatComponentBundle;
    prettierDefaults: GmlFormatDefaultOptions;
    formatSource: GmlSourceFormatter;
