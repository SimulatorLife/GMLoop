...
- [ ] **BUG**: In the UI on the "Docs" page, the toolbar is extremely tall and takes up a lot of vertical space; all the controls seem to be stacked instead of using the horizontal space.
