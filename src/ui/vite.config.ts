...
const DISABLED_MANIFEST_ENV_VALUE = "0";
...
const resolveUiViteConfiguration = () => {
    ...
    const shouldEmitManifest = process.env.GMLOOP_UI_BUILD_MANIFEST !== DISABLED_MANIFEST_ENV_VALUE;
