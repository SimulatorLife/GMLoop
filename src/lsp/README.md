...
- **FEAT**: VSCode extension hovering/tooltips over built-in functions/identifiers should show the function signature, params, return type, and description from the Manual (probably via the `gml-identifiers.json` file).
