...
export interface NamingConventionTargetProvider {
    listNamingConventionTargets(filePaths?: Array<string>, categories?: ReadonlyArray<NamingCategory>): MaybePromise<Array<NamingConventionTarget>>;
}
/**
 ...
 */
export interface SemanticAnalyzer extends SymbolResolver, OccurrenceTracker, FileSymbolProvider, DependencyAnalyzer, KeywordProvider, EditValidator {
}
/**
 ...
 */
export type PartialSemanticAnalyzer = Partial<SymbolResolver> & Partial<OccurrenceTracker> & Partial<FileSymbolProvider> & Partial<DependencyAnalyzer> & Partial<KeywordProvider> & Partial<EditValidator> & Partial<BatchWorkspaceOverlay> & Partial<NamingConventionTargetProvider> & Partial<MacroExpansionDependencyProvider>;
//# sourceMappingURL=semantic-analyzer-types.d.ts.map