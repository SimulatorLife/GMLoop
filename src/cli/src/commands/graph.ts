                            ...
                            fixtureDirectories.map(async (caseId) => {
                                ...
                                if (existsSync(configPath)) {
                                    ...
                                    try {
                                        ...
                                        // Treat unreadable configs as empty so a single broken
                                        // fixture cannot disable the entire playground surface.
                                        console.warn(
                                    ...
                                    try {
                                        ...
                                        // Same defensive policy: warn and skip this fixture so the
                                        // rest of the playground continues to render.
                                        console.warn(
