...
- Need a command to **inspect** if a given GML identifier (e.g. `gml/script/scr_player`, `scr_player`, or `max`) is a built-in or user-defined symbol, and if built-in, provide metadata about it (parameters, description, is it deprecated, etc.). If user-defined, provide information about where it's defined in the project and provide metadata from its definition/function-doc (parameters, type, etc.). NOTE: we do already have `graph search`, so we may just be able to leverage/enhance that instead. Or, we could have a separate command that just queries the manual-derived identifier snapshot for built-in metadata.
- Command like `read_runtime_log` to read the runtime log file in real-time with filtering, searching, and formatting options
- `kill_game` command to terminate the running GameMaker process/game
- `collect_compile_errors` command to collect and display compile errors from the GameMaker output/logs
- `launch_game` command to start the GameMaker game (with options for debug mode, etc.)
- `clean_cache` command to clear any cached data in the GameMaker IDE
- A performance profiling command for FPS, draw calls, texture swaps, memory, garbage creation, room load time, particle counts, pathfinding cost, and shader timings.
- 'Add to room' command to add an object instance, tile, sprite, layer, etc. to a room in a given layer / coordinates
- `list_rooms`
- `read_room`
- `add_instance_to_room`
- `move_instance`
- `delete_instance`
- `set_instance_creation_code`
- `set_room_camera`
- `set_viewport`
- `set_layer_depth`
- `add_tile_layer`
...
- `capture_room_preview`
- `open_room_in_runner(room_name)`
- `gml_resource_list`
- `gml_resource_find`
- `gml_resource_get`
- `gml_resource_exists`
- `gml_resource_rename`
- `gml_resource_duplicate`
- `gml_resource_move_folder`
- `gml_resource_get_dependencies`
- `gml_resource_get_dependents`
- `gml_resource_find_unused`
- `gml_resource_find_missing_references`
- `gml_resource_validate_references`
- `gml_resource_get_guid`
- `gml_resource_resolve_guid`
- `gml_resource_get_type`
- `gml_room_list`
- `gml_room_get`
- `gml_room_create`
- `gml_room_duplicate`
...
- `gml_room_open`
- `gml_room_save`
- `gml_room_set_dimensions`
- `gml_room_get_dimensions`
- `gml_room_set_speed`
- `gml_room_set_persistent`
- `gml_room_set_background_color`
- `gml_room_get_creation_code`
- `gml_room_set_creation_code`
- `gml_room_validate`
- `gml_room_repair`
- `gml_room_layer_list`
- `gml_room_layer_get`
- `gml_room_layer_create`
- `gml_room_layer_delete`
- `gml_room_layer_rename`
- `gml_room_layer_set_depth`
- `gml_room_layer_set_visible`
- `gml_room_layer_set_locked`
- `gml_room_layer_reorder`
- `gml_room_layer_move_resource`
- `gml_room_layer_find_by_name`
- `gml_room_layer_create_instance`
- `gml_room_layer_create_tilemap`
- `gml_room_layer_create_asset`
- `gml_room_layer_create_background`
- `gml_room_layer_create_path`
- `gml_room_layer_create_effect`
- `gml_room_query_at_point`
- `gml_room_query_in_rect`
- `gml_room_query_near`
- `gml_room_query_overlapping`
- `gml_room_query_out_of_bounds`
- `gml_room_query_empty_space`
- `gml_room_query_nearest_instance`
- `gml_room_query_instances_by_object`
- `gml_room_check_collision_between`
- `gml_room_check_collision_map`
- `gml_room_find_safe_spawn`
- `gml_room_find_safe_move`
- `gml_room_find_path_space`
- `gml_room_get_occupancy_grid`
- `gml_room_get_ascii_map`
- `gml_room_get_layout_summary`
- `gml_room_camera_list`
- `gml_room_camera_get`
- `gml_room_camera_set_enabled`
- `gml_room_camera_set_view_rect`
- `gml_room_camera_set_port_rect`
- `gml_room_camera_set_object_follow`
- `gml_room_camera_set_border`
- `gml_room_camera_set_speed`
- `gml_room_camera_frame_instances`
- `gml_room_camera_frame_rect`
- `gml_room_camera_validate`
- `gml_object_list`
- `gml_object_get`
- `gml_object_get_parent`
- `gml_object_set_parent`
- `gml_object_get_sprite`
- `gml_object_set_sprite`
- `gml_object_get_mask`
- `gml_object_set_mask`
- `gml_object_get_events`
- `gml_object_get_event_code`
- `gml_object_set_event_code`
- `gml_object_add_event`
- `gml_object_delete_event`
- `gml_object_has_event`
- `gml_object_get_physics_settings`
- `gml_object_set_physics_settings`
- `gml_object_validate_events`
- `gml_runner_start`
- `gml_runner_stop`
- `gml_runner_restart`
- `gml_runner_pause`
- `gml_runner_resume`
- `gml_runner_get_state`
- `gml_runner_get_logs`
- `gml_runner_clear_logs`
- `gml_runner_send_input`
- `gml_runner_send_keyboard`
- `gml_runner_send_mouse`
- `gml_runner_send_gamepad`
- `gml_runner_capture_screenshot`
- `gml_runner_capture_video`
- `gml_runner_set_room`
- `gml_runner_get_current_room`
- `gml_runtime_get_instances`
- `gml_runtime_get_instance`
- `gml_runtime_get_instance_variable`
- `gml_runtime_set_instance_variable`
- `gml_runtime_call_script`
- `gml_runtime_call_method`
- `gml_runtime_get_global_variable`
- `gml_runtime_set_global_variable`
- `gml_runtime_get_room_state`
- `gml_runtime_get_camera_state`
- `gml_runtime_get_draw_stats`
- `gml_runtime_get_audio_state`
- `gml_runtime_get_error_log`
- `gml_runtime_watch_expression`
- `gml_test_list`
- `gml_test_run`
- `gml_test_run_group`
- `gml_test_get_results`
- `gml_test_create_case`
- `gml_test_update_case`
- `gml_replay_record`
- `gml_replay_run`
- `gml_replay_compare`
- `gml_replay_assert_room`
- `gml_replay_assert_instance_exists`
- `gml_replay_assert_variable`
- `gml_replay_assert_no_errors`
- `gml_profile_start`
- `gml_profile_stop`
- `gml_profile_get_fps`
- `gml_profile_get_frame_time`
- `gml_profile_get_memory`
- `gml_profile_get_draw_calls`
- `gml_profile_get_texture_swaps`
- `gml_profile_get_instance_counts`
- `gml_profile_get_room_load_time`
- `gml_profile_get_script_timings`
- `gml_profile_get_gc_pressure`
- `gml_profile_capture_snapshot`
- `gml_profile_compare_snapshots`
- `gml_profile_report`
- `gml_ui_layout_get`
- `gml_ui_layout_validate`
- `gml_ui_anchor_check`
- `gml_ui_text_overflow_check`
- `gml_ui_safe_area_check`
- `gml_ui_create_placeholder_hud`
- `gml_ui_create_menu_room`
- `gml_ui_place_button`
- `gml_ui_place_text`
- `gml_ui_preview_resolution`
- `gml_ui_preview_resolutions`